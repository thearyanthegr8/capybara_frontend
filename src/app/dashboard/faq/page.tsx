      ...
      <Accordion type="single" collapsible>
        ...
        <AccordionItem value="item-2">
          ...
          <AccordionContent>
            ...
            dashboard where you can track and manage your patients&apos;
            prescription history. You can view past prescriptions
          </AccordionContent>
        </AccordionItem>
        ...
        <AccordionItem value="item-4">
          ...
          <AccordionContent>
            When creating a prescription, you&apos;ll need to provide basic
            patient information such as name, age, and contact details, along
            with details of the prescribed medications, dosage instructions, and
            any additional notes or precautions.
          </AccordionContent>
        </AccordionItem>
        <AccordionItem value="item-5">
          ...
          <AccordionContent>
            ...
            navigate to the &quot;Subscription&quot; or &quot;Token Packs&quot;
            section in your account settings. Follow the prompts to select your
            desired plan or token pack and complete the payment process
            securely.
          </AccordionContent>
        </AccordionItem>
      </Accordion>
      ...
      <Accordion type="single" collapsible>
        <AccordionItem value="item-1">
          ...
          <AccordionContent>
            ...
            QR code on the prescription using the platform&apos;s QR code
            scanner, and the system will retrieve the prescription details from
            the blockchain for validation.
          </AccordionContent>
        </AccordionItem>
        <AccordionItem value="item-2">
          <AccordionTrigger>
          ...
          <AccordionContent>
            ...
            verification, follow your organization&apos;s protocol for handling
            such cases. You may contact the prescribing doctor or healthcare
            facility for clarification, or report the issue to the appropriate
        ...
        <AccordionItem value="item-4">
          ...
          <AccordionContent>
            ...
            camera-enabled device with your login credentials. Whether
            you&apos;re using a tablet, or smartphone, you can securely log in
            to your account and verify prescriptions from anywhere with an
            internet connection.
          </AccordionContent>
        </AccordionItem>
      </Accordion>
